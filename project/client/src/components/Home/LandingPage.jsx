...
const LandingPage = () => {
  ...
  return (
    <Box>
      <Grid
        style={{
          background: "linear-gradient(to right bottom, #eeaeca, #94bbe9)",
        }}
        container
        spacing={2}
        columns={16}
      ...
      >
        <Grid item xs={8}>
          ...
          <Typography color="white" paddingLeft={"1rem"}>
            Lorem ipsum dolor sit amet consectetur, adipisicing elit. Nisi
            sapiente eos id quidem, illo facere eligendi voluptatem vel eaque
            numquam quae ducimus, minus esse autem quaerat, fugiat dolorum quo
            voluptates.
          </Typography>
        </Grid>
        <Grid
          ...
          sx={{
            backgroundImage:
              "url(https://images.unsplash.com/photo-1536329583941-14287ec6fc4e?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1480&q=80)",
